                                ...
                                while ($arr2 = mysqli_fetch_array($que2)) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                          ...
                                          ?>
                                          <td><a href="../Admin/book_view.php?id=<?php echo $arr2['book_id']; ?>"><button class="author-verified-button">Book View</button></a></td>
                                        <?php
                                        } else {
                                        ?>
                                        <td><button class="author-unverified-button">Wait</button></td>
                                        <?php
                                        }
                                        ?>
                                        <td><a href="../Author/delete_book.php?id=<?php echo $arr2['book_id']; ?>"><button class="author-unverified-button">Delete</button></a></td>
                                      </tr>
                                <?php
                                }
                                if(!$count){
